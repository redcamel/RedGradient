...
const renderGradientEdit = function (rootComponentState, activeSubData, canvasInfo, appState, editMode) {
  ...
  if (RedCanvas.ghostMode===1 && !RedCanvas.ghostSize) RedCanvas.ghostSize = {...layoutSize};
  ...
  return <>
    <div
      ...
      style={{
        ...
        opacity: RedCanvas.ghostMode===1&& editMode  ? 1 : 0,
