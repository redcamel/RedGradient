...
class RedFilterDropShadow extends React.Component {
  static getCss;
  ...
  getCss(filterData) {
    return RedFilterDropShadow.getCss(filterData);
  }
...
RedFilterDropShadow.getCss = filterData => {
...
RedFilterDropShadow.getNewDataValues = () => {
  return {
    offsetX: 2,
    offsetY: 4,
    radius: 6,
...
export default RedFilterDropShadow;
